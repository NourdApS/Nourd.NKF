...
Source Or Configuration repository to a complete checked and reviewed NKF 0.5 candidate
...
the later 0.5 graph candidate, prove the semantic category, or establish
conformance.
...
isolated 0.5 candidate, writes its complete review template to that path, and
