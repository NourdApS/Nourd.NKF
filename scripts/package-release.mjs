...
import { ACCEPTED_0_81_ARTIFACT_DIGESTS } from "./release/config.mjs";
import {
  readReleaseSet,
...
const memberEntries = releaseEntriesForVersion("0.81", releaseSet);
...
for (const [artifactPath, expected] of Object.entries(
  ACCEPTED_0_81_ARTIFACT_DIGESTS,
)) {
...
await invokeVerifiedChecker(verification, [
  "--project",
  path.join(repositoryRoot, "fixtures/valid/minimal-0-81"),
  "--level",
  "full-bundle",
  "--runner",
