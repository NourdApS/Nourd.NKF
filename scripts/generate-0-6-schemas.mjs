...
const source = Object.freeze({
  nkf_version: "0.6",
  markdown_path: "knowledge/specifications/nkf-0.6-revision-3.md",
  markdown_digest: {
    algorithm: "sha-256",
    value: "bb602be39dbbb5d7c4f97726ea70a46da6af41cfc5de6c25ab6bac9beddfcb6a",
  },
  executable_path: "contracts/nkf/0.6/revision-3/nkf.yaml",
  executable_digest: {
    algorithm: "sha-256",
    value: "7366ea1276282990733339e5bb4464ab9d9259592d5cffb2a84b000f734fd5e4",
  },
});

const schemaRoot = path.join(root, "contracts/nkf/0.6/schemas");
...
async function bundleSchema() {
  ...
  schema.$id = "urn:nkf:0.6:schema:bundle";
  schema.title = "NKF 0.6 bundle";
  schema["x-nkf-source"] = source;
  schema.required.push("knowledge_graph");
  schema.properties.nkf_version = { const: "0.6" };
  ...
  schema.$defs.knowledgeGraph = object(["policy", "baseline"], {
    policy: { const: "nkf.freshness-policy.0.6" },
...
async function recordSchema() {
  ...
  schema.$id = "urn:nkf:0.6:schema:record";
  schema.title = "NKF 0.6 record";
  schema["x-nkf-source"] = source;
...
function policySchema() {
  ...
  return envelope(
    ...
    "NKF 0.6 freshness policy",
    {
      contract: { const: "nkf.freshness-policy" },
      nkf_version: { const: "0.6" },
      id: { const: "nkf.freshness-policy.0.6" },
...
async function validationResultSchema() {
  ...
  schema.$id = "urn:nkf:0.6:schema:validation-result";
  schema.title = "NKF 0.6 validation result";
  schema["x-nkf-source"] = source;
  schema.properties.nkf_version = { const: "0.6" };
  ...
  schema.$defs.knowledgeGraph = object(["policy", "candidate_graph_revision", "baseline_graph_revision", "baseline_state", "node_count", "authored_edge_count", "projection_counts"], {
    policy: object(["identity", "digest", "binding"], {
      identity: { const: "nkf.freshness-policy.0.6" }, digest, binding: { enum: ["verified", "unavailable", "mismatched"] },
    }),
    candidate_graph_revision: nullable(digest),
    baseline_graph_revision: nullable(digest),
    baseline_state: { enum: ["confirmed", "missing", "outdated", "disputed", "ambiguous", "unsupported", "not-evaluated"] },
  ...
  for (const identity of identities) {
    ...
    schema.$defs[key] = { allOf: [ref("schemaBinding"), { type: "object", properties: { identity: { const: `urn:nkf:0.6:schema:${identity}` } } }] };
...
async function releaseManifestSchema() {
  ...
  schema.$id = "urn:nkf:0.6:schema:release-manifest";
  schema.title = "NKF 0.6 release manifest";
  schema["x-nkf-source"] = source;
  schema.properties.nkf_version = { const: "0.6" };
  ...
  schema.$defs.freshnessPolicy = object(["identity", "path", "digest"], {
    identity: { const: "nkf.freshness-policy.0.6" },
  ...
  for (const identity of identities) {
    ...
    schema.$defs[key] = {
      allOf: [ref("schemaArtifact"), {
        type: "object",
        properties: {
          identity: { const: `urn:nkf:0.6:schema:${identity}` },
