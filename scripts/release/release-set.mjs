...
export const CURRENT_RELEASE_VERSION = "0.81";
...
export function releaseClassesForVersion(nkfVersion) {
  if (["0.7", "0.71", "0.8", "0.81"].includes(nkfVersion)) return RELEASE_CLASSES;
  if (nkfVersion === "0.6") {
...
export function validateReleaseSet(value) {
  ...
  if (
    ...
    !["0.6", "0.7", "0.71", "0.8", "0.81"].includes(value.nkf_version) ||
