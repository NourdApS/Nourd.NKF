...
Under native NKF {{nkf_version}} frontmatter, a record carries only common orientation plus
...
declared {{nkf_predecessor}}-to-{{nkf_version}} upgrade beneath the one public Adopt operation. A
