...
initial NKF {{nkf_version}} adoption. It applies before the project has a project-root
`.nourd` directory.
...
isolated {{nkf_version}} candidate, writes a complete candidate-specific review template,
