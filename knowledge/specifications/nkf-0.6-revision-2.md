---
id: nkf-0.6-specification-revision-2
...
created_at: 2026-08-13T22:25:00Z
---
...
- **Canonical destination:** `knowledge/specifications/nkf-0.6-revision-2.md`
- **Executable companion destination:** `contracts/nkf/0.6/revision-2/nkf.yaml`
...
promotion input at
`knowledge/evidence/release/nkf-0.6-revision-2-producer-promotion.yaml`. That input is a
...
`.nourd/knowledge/records/nkf-0.6-specification-revision-2.yaml`, including the prospective
...
`9e73217229f54bd0ff32821eda466cbe4ebf5037dab9b4772d0e41e524504f15`
and its exact native declaration SHA-256 is
`00c45c815056e06dc0dc3b54fdd2790dfe3bd616ec664401157089cc169fde7b`.
...
original NKF 0.6 Specification, executable, policy, and producer-promotion
input as current release authority, and MUST select this revision-2 set
...
`adr-0124`; its digest is supplied and verified separately as the exact
...
- `knowledge/specifications/nkf-0.6-revision-2.md`; and
- `contracts/nkf/0.6/revision-2/nkf.yaml`.
