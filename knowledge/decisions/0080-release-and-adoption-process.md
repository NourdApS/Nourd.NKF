...
[NKF-020](../tasks/deferred/NKF-020-version-release-adoption-and-compatibility-process.md). Shipping NKF 0.2 needs the processes now, and the Human Product
...
It reduces deferred [NKF-020](../tasks/deferred/NKF-020-version-release-adoption-and-compatibility-process.md) to breaking-change classification and signaling
...
the process as [NKF-020](../tasks/deferred/NKF-020-version-release-adoption-and-compatibility-process.md) draft input until after NKF 0.2 was rejected because
...
guidance marker. [NKF-020](../tasks/deferred/NKF-020-version-release-adoption-and-compatibility-process.md) narrows rather than closes.
...
- define breaking-change classification and signaling, which remain
  deferred to [NKF-020](../tasks/deferred/NKF-020-version-release-adoption-and-compatibility-process.md).
