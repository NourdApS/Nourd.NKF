...
- [`../designs/nkf-0.1-schema-status-reconciled-bundle-schema-proposal.json`](../designs/nkf-0.1-schema-status-reconciled-bundle-schema-proposal.json);
- [`../designs/nkf-0.1-schema-status-reconciled-record-schema-proposal.json`](../designs/nkf-0.1-schema-status-reconciled-record-schema-proposal.json); and
- [`../designs/nkf-0.1-schema-status-reconciled-validation-result-schema-proposal.json`](../designs/nkf-0.1-schema-status-reconciled-validation-result-schema-proposal.json).
