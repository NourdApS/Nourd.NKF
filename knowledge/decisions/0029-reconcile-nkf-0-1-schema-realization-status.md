...
- **Normative Markdown Proposal:**
  [`../designs/nkf-0.1-schema-status-reconciled-specification-proposal.md`](../designs/nkf-0.1-schema-status-reconciled-specification-proposal.md)
- **Executable YAML Proposal:**
  [`../designs/nkf-0.1-schema-status-reconciled-contract-proposal.yaml`](../designs/nkf-0.1-schema-status-reconciled-contract-proposal.yaml)
