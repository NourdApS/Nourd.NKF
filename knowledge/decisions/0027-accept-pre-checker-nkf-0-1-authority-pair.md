...
- **Normative Markdown Proposal:**
  [`../designs/nkf-0.1-pre-checker-specification-proposal.md`](../designs/nkf-0.1-pre-checker-specification-proposal.md)
- **Executable YAML Proposal:**
  [`../designs/nkf-0.1-pre-checker-contract-proposal.yaml`](../designs/nkf-0.1-pre-checker-contract-proposal.yaml)
