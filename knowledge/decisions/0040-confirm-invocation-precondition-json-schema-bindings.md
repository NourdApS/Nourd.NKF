...
- [`../designs/nkf-0.1-invocation-precondition-bundle-schema-proposal.json`](../designs/nkf-0.1-invocation-precondition-bundle-schema-proposal.json);
- [`../designs/nkf-0.1-invocation-precondition-record-schema-proposal.json`](../designs/nkf-0.1-invocation-precondition-record-schema-proposal.json);
  and
- [`../designs/nkf-0.1-invocation-precondition-validation-result-schema-proposal.json`](../designs/nkf-0.1-invocation-precondition-validation-result-schema-proposal.json).
