...
- [`../designs/nkf-0.1-replacement-specification.md`](../designs/nkf-0.1-replacement-specification.md);
  and
- [`../designs/nkf-0.1-replacement-contract-set.yaml`](../designs/nkf-0.1-replacement-contract-set.yaml).
