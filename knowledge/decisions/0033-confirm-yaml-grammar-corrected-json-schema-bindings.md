...
- [`../designs/nkf-0.1-yaml-grammar-corrected-bundle-schema-proposal.json`](../designs/nkf-0.1-yaml-grammar-corrected-bundle-schema-proposal.json);
- [`../designs/nkf-0.1-yaml-grammar-corrected-record-schema-proposal.json`](../designs/nkf-0.1-yaml-grammar-corrected-record-schema-proposal.json); and
- [`../designs/nkf-0.1-yaml-grammar-corrected-validation-result-schema-proposal.json`](../designs/nkf-0.1-yaml-grammar-corrected-validation-result-schema-proposal.json).
