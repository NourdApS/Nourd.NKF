...
3. Defining the release process, the adoption process, and breaking-change
   classification and signaling is deferred to [`NKF-020`](../tasks/completed/NKF-020-version-release-adoption-and-compatibility-process.md), created by explicit
...
historical `0.11` references, corrected by this Decision. Until [NKF-020](../tasks/completed/NKF-020-version-release-adoption-and-compatibility-process.md) is
...
- define, accept, or implement the release, adoption, or breaking-change
  processes deferred to [NKF-020](../tasks/completed/NKF-020-version-release-adoption-and-compatibility-process.md);
- authorize beginning [NKF-020](../tasks/completed/NKF-020-version-release-adoption-and-compatibility-process.md) work; and
