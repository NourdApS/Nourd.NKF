...
[ADR 0071](0071-complete-portable-onboarding-topology.md) adopted the complete portable onboarding topology, but explicitly did
...
receipt-bound predecessor repair exactly as adopted by [ADR 0071](0071-complete-portable-onboarding-topology.md).
...
It does not activate [NKF-014](../tasks/deferred/NKF-014-expand-brownfield-and-advanced-onboarding.md), migrate Nourd Agent SDK, or change the meaning of
...
Implementing directly from [ADR 0071](0071-complete-portable-onboarding-topology.md) was rejected because a Design and Decision
...
onboarded [NKF-013](../tasks/completed/NKF-013-initial-greenfield-onboarding.md) or [NKF-015](../tasks/completed/NKF-015-agent-led-initial-onboarding.md) repositories may use the trusted-receipt repair
...
self-hosted snapshot. [NKF-017](../tasks/completed/NKF-017-complete-portable-onboarding-topology.md) then requires a whole-repository audit and a
