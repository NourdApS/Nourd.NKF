...
# Supporting Current Realizations

These Realizations supplement the consolidated current-system view. Their
frontmatter records confirmation status; this index does not confirm them.

- [Agent-Led Initial Onboarding](agent-led-initial-onboarding.md)
- [Checker And Validation](checker-and-validation.md)
