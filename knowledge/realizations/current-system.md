...
| Start Here website | `website/`, `.github/workflows/nkf-website.yml` | Nourd-branded Astro Starlight explanation: six pages covering introduction, problem, audience, fit, workflow, and high-level mechanics, with eight diagrams, search, mobile navigation, and light/dark themes; outside the immutable release set | Sample implementation and public GitHub Pages delivery verified under the explicit scope of [NKF-039](../tasks/items/NKF-039-publish-the-start-here-website.md); this is explanatory source and does not accept Company brand policy, revise normative meaning, or confirm the whole Realization |
