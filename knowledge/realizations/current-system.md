...
technically confirms only those exact implementation and private archive
bytes. Publication, recommendation, ordinary producer adoption, and the
post-adoption audit have not yet occurred.
...
| Core JSON Schemas | `contracts/nkf/0.2/schemas/`, `contracts/nkf/0.3/schemas/`, `contracts/nkf/0.4/schemas/`, `contracts/nkf/0.5/schemas/` | Source-bound predecessor Schemas plus seven closed 0.5 candidate Schemas | 0.4 exact digests confirmed by [ADR 0114](../decisions/0114-confirm-the-nkf-0-4-release-candidate.md); 0.5 exact digests confirmed by [ADR 0120](../decisions/0120-confirm-the-nkf-0-5-release-candidate.md) |
| Checker library and CLI | `src/checker/`, `src/cli.ts`, `dist/nourd-nkf-checker.mjs` | Version-dispatching checker with exact 0.2 through 0.5 bindings; 0.5 candidate checker SHA-256 `95f53b25...` | Exact 0.5 candidate build confirmed by [ADR 0120](../decisions/0120-confirm-the-nkf-0-5-release-candidate.md); installed producer checker remains pinned to 0.4 until public adoption |
...
`contracts/nkf/0.4/`, and the accepted prepublication revision 2 authority
