...
[`../designs/product-responsibility-identifiers.md`](../../designs/adopted/product-responsibility-identifiers.md).
...
[`ADR 0004`](../../decisions/0004-historical-record-contract-versioning.md).

### Serialization proposal

The proposed section-local YAML field and deterministic coverage rules are
recorded in
[`../designs/record-v2-responsibility-bindings.md`](../../designs/superseded/record-v2-responsibility-bindings.md).
...
[`ADR 0006`](../../decisions/0006-pre-stable-evolution.md).
...
immutable result is
[`ADR 0007`](../../decisions/0007-markdown-yaml-authority.md).

### Artifact proposal

The proposed NKF version, canonical paths, YAML contract identity, and
creation sequence are recorded in
[`../designs/artifact-identities-and-contract-versioning.md`](../../designs/superseded/artifact-identities-and-contract-versioning.md).
...
[`../designs/nkf-0.1-independent-specification.md`](../../evidence/decision-inputs/adr-0010/nkf-0.1-independent-specification.md).
...
result is [`ADR 0009`](../../decisions/0009-nkf-0-1-version-namespace.md).
...
is recorded in
[`ADR 0012`](../../decisions/0012-nkf-0-1-artifact-authority.md).
...
[`../designs/nkf-0.1-executable-completeness-gaps.md`](../../evidence/audits/nkf-0.1-executable-completeness-gaps.md).
...
[`ADR 0013`](../../decisions/0013-native-record-serialization.md).
...
2026. The immutable result is
[`ADR 0014`](../../decisions/0014-section-role-vocabularies.md).
...
[`ADR 0015`](../../decisions/0015-semantic-topology-and-bindings.md).
...
29 July 2026. The immutable result is
[`ADR 0017`](../../decisions/0017-acceptance-provenance.md).
...
immutable result is
[`ADR 0018`](../../decisions/0018-project-paths-and-knowledge-coverage.md).
...
[`ADR 0020`](../../decisions/0020-presentation-guidance.md).
...
29 July 2026. The immutable result is
[`ADR 0021`](../../decisions/0021-native-bundle-serialization.md).
...
| --- | --- | --- |
| [`nkf-0.1-replacement-specification.md`](../../evidence/decision-inputs/adr-0022-0023/nkf-0.1-replacement-specification.md) | `knowledge/specifications/nkf-0.1.md` | `9e90fc712df661b7c008b47a8392a180c5418346f8c3a5a1f2c344c6cbeb3b97` |
| [`nkf-0.1-replacement-contract-set.yaml`](../../evidence/decision-inputs/adr-0022-0023/nkf-0.1-replacement-contract-set.yaml) | `contracts/nkf/0.1/nkf.yaml` | `ebb8c98dfb4611cffe4c19eeebd5fcd932d48332067393c0c7ee7a6f07ac6e87` |
...
[`ADR 0022`](../../decisions/0022-native-authority-pair.md)
...
[`../designs/replacement-json-schema-realization.md`](../../designs/superseded/replacement-json-schema-realization.md).

| Proposed artifact | SHA-256 |
| --- | --- |
| `knowledge/evidence/decision-inputs/adr-0022-0023/nkf-0.1-bundle-schema-proposal.json` | `daf7b15f8b6edc143be10f6d832dc740b0f36292fdace0198495a9e51bb94574` |
| `knowledge/evidence/decision-inputs/adr-0022-0023/nkf-0.1-record-schema-proposal.json` | `f22a9ed1a8a4d2e56003e7c50e757bcb8bd5a7f09169f817e29dbcb85388502a` |
...
[`ADR 0023`](../../decisions/0023-native-json-schemas.md)
...
[`ADR 0024`](../../decisions/0024-deterministic-markdown-structure-and-title-case.md)
...
[`../designs/nkf-0.1-validation-result-schema-proposal.json`](../../evidence/decision-inputs/adr-0025/nkf-0.1-validation-result-schema-proposal.json).
...
- [`ADR 0025`](../../decisions/0025-validation-result.md),
...
- [`ADR 0027`](../../decisions/0027-validation-authority-pair.md),
  ...
  and
- [`ADR 0028`](../../decisions/0028-validation-json-schemas.md),
...
- [`ADR 0029`](../../decisions/0029-schema-realization-status.md)
...
- [`ADR 0030`](../../decisions/0030-source-bound-json-schemas.md)
...
[`nkf-0.1-native-checker-realization-findings.md`](../../evidence/audits/nkf-0.1-native-checker-realization-findings.md).
...
[`../designs/nkf-0.1-native-checker-realization-findings.md`](../../evidence/audits/nkf-0.1-native-checker-realization-findings.md)
...
[`ADR 0041`](../../decisions/0041-checker-development-realization.md)
...
[`ADR 0042`](../../decisions/0042-release-distribution.md).
...
[`../designs/initial-release-distribution.md`](../../designs/adopted/initial-release-distribution.md).
...
recorded in
[`ADR 0043`](../../decisions/0043-release-manifest.md).
...
[`../designs/nkf-0.1-release-manifest-schema-proposal.json`](../../evidence/decision-inputs/adr-0043-0046/nkf-0.1-release-manifest-schema-proposal.json).
...
[`NKF-006`](../deferred/NKF-006-extensible-root-models.md).
...
[`ADR 0049`](../../decisions/0049-common-and-root-profiles.md).

The current exact realization proposal is
[`../designs/common-and-root-profiles.md`](../../designs/adopted/common-and-root-profiles.md).
...
[`../designs/technology-root-profile.md`](../../designs/adopted/technology-root-profile.md).
...
[`../designs/product-technology-common-allocation.md`](../../designs/adopted/product-technology-common-allocation.md).
...
NKF-003 is completed because it established the independent repository
authority, imported provenance, accepted the NKF 0.1 Common Specification
with Product and Technology Profiles, derived the contract and checker
realization, and exercised the initial Technology self-hosting boundary.
...
validation result, release package, or consumer state into current
confirmation.
