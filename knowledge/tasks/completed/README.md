...
summary: Completed Tasks retained as durable intent and completion provenance.
...
state without replacing Decisions, Realizations, or validation Evidence.

- [NKF-003: Establish Independent NKF Authority](NKF-003-independent-nkf-authority.md)
- [NKF-007: Repair Knowledge Structure And Confirmation](NKF-007-knowledge-structure-and-confirmation.md)
- [NKF-008: Publish NKF, Public Documentation, And Consumer Adoption](NKF-008-publish-and-onboard-consumers.md)
- [NKF-010: Adopt Governed Frontmatter](NKF-010-governed-frontmatter-adoption.md)
- [NKF-011: Enforce NKF Contracts](NKF-011-enforce-nkf-contracts.md)
