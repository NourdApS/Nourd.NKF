...
- **Authority Effect:** None. This document defines a reviewable Technology
...
| Design | Zero or more | A proposed or accepted solution structure, interaction, or architecture |
...
7. `validation-and-acceptance-evidence`; and
