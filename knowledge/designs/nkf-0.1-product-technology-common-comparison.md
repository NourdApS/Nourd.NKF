...
- **Technology Source:**
  `knowledge/designs/nkf-0.1-technology-root-profile-specification-proposal.md`
- **Prepared:** 30 July 2026
- **Authority Effect:** None. The current Product specification is accepted;
...
| Design | Problem and scope, governing inputs, proposed or accepted design, responsibilities and interactions, alternatives and trade-offs, failure and recovery, validation evidence, unresolved matters; no implementation claim | Profiles may constrain permitted design kinds and profile-specific governing inputs |
