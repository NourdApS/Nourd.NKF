...
- **Acceptance Decisions:** ADR 0045, ADR 0050, ADR 0054, ADR 0055, ADR
  0056, ADR 0058, ADR 0071, and ADR 0072
- **Independent governing inputs:** ADRs 0001 through 0072
...
> bound by ADR 0072 and its executable companion. It
...
accepts this exact successor Markdown and executable authority pair.
...
the confirmed predecessor against Nourd Agent SDK. ADR 0072 accepts this exact
successor authority pair. The change adds a durable Common lifecycle envelope,
one canonical reconciled knowledge map, lifecycle placement and index
completeness, profile-specific initial scaffolds, and deliberate predecessor
repair without adding another Root Profile or version namespace.
