...
defined by its versioned body contract. A native declaration MUST bind every
...
required responsibility. Those identifiers are versioned by the body
contract. Renaming, splitting, combining, adding, or removing a required
responsibility is therefore a body-contract compatibility change rather than
