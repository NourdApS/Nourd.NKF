...
initial NKF 0.71 adoption. It applies before the project has a project-root
`.nourd` directory.
...
isolated 0.71 candidate, writes a complete candidate-specific review template,
