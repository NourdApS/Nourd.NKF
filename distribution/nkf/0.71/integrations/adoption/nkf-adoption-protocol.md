...
| Repository declaring NKF 0.1 through 0.6 | Out of window | Fails closed naming the exact stepping-stone release archive |
...
explicit archive and digest: a repository declaring NKF 0.6 steps through the
published NKF 0.7 archive, and older repositories step through their next
published archive in turn. The refusal names the exact next stepping-stone
