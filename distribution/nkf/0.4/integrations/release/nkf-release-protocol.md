...
0.4 release. It is operational process carried in the complete versioned set;
...
`contracts/nkf/0.4/release-set.yaml`, and a passing `npm run nkf:check`. The
...
- disclose and receive the already authorized breaking 0.2-to-0.4 migration;
...
- migrate the bundle to 0.4 and pass the extracted candidate checker;
