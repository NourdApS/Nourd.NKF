...
0.3 release. It is operational process carried in the complete versioned set;
...
`contracts/nkf/0.3/release-set.yaml`, and a passing `npm run nkf:check`. The
...
- disclose and receive the already authorized breaking 0.2-to-0.3 migration;
...
- migrate the bundle to 0.3 and pass the extracted candidate checker;
...
accepted authority and Schema bindings, checker and adopter execution, 0.1 and
0.2 migrations, same-version refresh, host-superset preservation,
