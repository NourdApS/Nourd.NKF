...
initial NKF 0.81 adoption. It applies before the project has a project-root
`.nourd` directory.
...
isolated 0.81 candidate, writes a complete candidate-specific review template,
